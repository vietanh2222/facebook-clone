...
function DeleteConfirm({
  isPost,
  handleRemovePost,
  handleCloseDeleteConFirmPost,
  handleCloseDeleteConfirmComment,
  handleRemoveComment,
}) {
  return (
    <div
      ...
      onClick={
        isPost ? handleCloseDeleteConFirmPost : handleCloseDeleteConfirmComment
      }
    >
      <div
        className="DeleteConfirm__wrapper"
      ...
      >
        ...
        <div className="DeleteConfirm__body">
          ...
          <div className="DeleteConfirm__options">
            ...
            <button onClick={isPost ? handleRemovePost : handleRemoveComment}>
              Yes
            </button>
          </div>
        </div>
